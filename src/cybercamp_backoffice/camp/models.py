...
class User(AbstractUser):
	...
	wa_world = models.CharField(max_length=30, help_text='WorldSlug, for start map', default='eulenspiegel')
	wa_room = models.CharField(max_length=30, help_text='RoomSlug, for start map', default='basemap.json')
